...
$statusData = [];
$query = "SELECT report_status, report_month FROM scholar_thesis_expenses"; 
...
if (date('m-d') == '01-01') {
    $resetQuery = "UPDATE scholar_thesis_expenses SET report_status = 'Not Submitted'";
                    ...
                    <div class="card-body d-flex py-2 shadow-sm" style="border-radius: 10px;">
                        ...
                        <div class="col-7" style="width: 60%;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="thesis_expenses.php?month=' . $monthKey . '" class="btn btn-lg" style="background-color: #003c3c; color: #fff; border-radius: 5px; padding: 7px 23px; font-size: 0.7rem; font-weight: 700;">View Forms</a>
